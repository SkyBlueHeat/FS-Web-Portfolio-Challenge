      ...
      <div className="px-4 mx-auto max-w-7xl sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-12">
            <h2 className="text-4xl font-bold text-gray-900 mb-4">Open to U.S. Software Training Opportunities</h2>
          ...
          <div className="bg-white dark:bg-gray-700 rounded-2xl shadow-lg p-8 lg:p-12">
            <div className="space-y-6">
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <div className="space-y-4">
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="text-lg font-semibold text-gray-900">Designated J-1 Sponsor</h4>
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="text-lg font-semibold text-gray-900">U.S. Host Company</h4>
                      <p className="text-gray-600">
                  ...
                  <div className="flex items-start">
                    ...
                    <div>
                      <h4 className="text-lg font-semibold text-gray-900">Structured Training Program</h4>
                      <p className="text-gray-600">
              ...
              <div className="border-t border-gray-200 pt-6">
                <h3 className="text-2xl font-bold text-gray-900 mb-3">What I Bring</h3>
                <ul className="space-y-2">
                  <li className="flex items-start">
                    <span className="text-blue-600 mr-2 mt-1">•</span>
                    <span className="text-gray-600">Professional software development experience in frontend and full-stack development</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-600 mr-2 mt-1">•</span>
                    <span className="text-gray-600">Strong foundation in React, TypeScript, JavaScript, and Python</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-600 mr-2 mt-1">•</span>
                    <span className="text-gray-600">Experience with automated testing, performance optimization, and accessibility</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-600 mr-2 mt-1">•</span>
                    <span className="text-gray-600">Proven ability to build and ship independent full-stack products</span>
                  </li>
                  <li className="flex items-start">
                    <span className="text-blue-600 mr-2 mt-1">•</span>
                    <span className="text-gray-600">Eagerness to learn and contribute to a professional development team</span>
                  </li>
                </ul>
              </div>
